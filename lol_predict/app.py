...
fig.add_annotation(x=90, y=1.7, text=odds_text, showarrow=False, align='left', bordercolor="#c7c7c7", borderwidth=2, borderpad=4, bgcolor="pink", font=dict(size=10, color="navy"))
...
app.layout = html.Div(
    [
        ...
        [
            ...
            dcc.Graph(id='win-plot', figure=fig, style={'width': '80%', 'align-items':'center', 'display':'inline-block','justify-content': 'center'})
        ], 
        id='my-div', style={'textAlign':'center'}), 
        ...
        html.Div(
            [
                ...
                dcc.Input(id='blueWardsDestroyed', type='number', placeholder='(0~300)', min=0, max=300),
                html.Label('Wards Placed by Red'),
                dcc.Input(id='redWardsPlaced', type='number', placeholder='(0~300)', min=0, max=300),
                html.Label('Wards Destroyed by Red'),
                dcc.Input(id='redWardsDestroyed', type='number', placeholder='(0~300)', min=0, max=300),
                html.Label('Towers Destroyed by Blue'),
                dcc.Dropdown(
                    id='blueTowersDestroyed', options=[
                        {'label':'0', 'value':0},
                        {'label':'1', 'value':1},
                        {'label':'2', 'value':2}
                    ], multi=False),
        ...
        html.Div(
            [
                ...
                dcc.RadioItems(
                    id='blueFirstBlood',
                    options=[{'label':'Blue', 'value':1}, {'label':'Red', 'value':0}],
                    labelStyle={'display':'inline-block'}),
                html.Label('Kills by Blue(Red Deaths)'),            
                dcc.Input(id='blueKills', type='number', placeholder='Input data', min=0, max=40),
                html.Label('Kills by Red(Blue Deaths)'),            
                dcc.Input(id='blueDeaths', type='number', placeholder='Input data', min=0, max=40),
                html.Label('Kill Assists by Blue'),            
                dcc.Input(id='blueAssists', type='number', placeholder='Input data', min=0, max=40),
                html.Label('Kill Assists by Red'),  
                dcc.Input(id='redAssists', type='number', placeholder='Input data', min=0, max=40),
            ],
            id='kills',
            className='pretty_container two columns'
        ),
        html.Div(
            [
                ...
                dcc.Input(id='blueTotalMinionsKilled', type='number', placeholder='(0~300)', min=0, max=300),
                html.P('Jungle Minions Kill by Blue'),  
                dcc.Input(id='blueTotalJungleMinionsKilled', type='number', placeholder='(0~100)', min=0, max=100),
                ],
            id='monsters-blue',
            className='pretty_container two columns',
        ),
        html.Div(
            [
                ...
                dcc.Input(id='redTotalMinionsKilled', type='number', placeholder='(0~300)', min=0, max=300),
                html.Label('Total Jungle Minions Kill by Red'),
                dcc.Input(id='redTotalJungleMinionsKilled', type='number', placeholder='(0~100)', min=0, max=100),
            ],
            id='monsters-red',
            className='pretty_container two columns'
        ),
...
def update_figure(blueWardsPlaced, blueWardsDestroyed, blueFirstBlood, blueKills, blueDeaths, blueAssists, blueDragons, blueHeralds, blueTowersDestroyed, blueTotalGold, blueTotalExperience, blueTotalMinionsKilled, blueTotalJungleMinionsKilled, redWardsPlaced, redWardsDestroyed, redAssists, redDragons, redHeralds, redTowersDestroyed, redTotalGold, redTotalExperience, redTotalMinionsKilled, redTotalJungleMinionsKilled):
    
    test_row = new_row_helper(blueWardsPlaced, blueWardsDestroyed, blueFirstBlood, blueKills, blueDeaths, blueAssists, blueDragons, blueHeralds, blueTowersDestroyed, blueTotalGold, blueTotalExperience, blueTotalMinionsKilled, blueTotalJungleMinionsKilled, redWardsPlaced, redWardsDestroyed, redAssists, redDragons, redHeralds, redTowersDestroyed, redTotalGold, redTotalExperience, redTotalMinionsKilled, redTotalJungleMinionsKilled)
